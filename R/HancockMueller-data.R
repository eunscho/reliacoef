#' Hancock and Mueller's (2001)  unidimensional data of four items
#'
#' Hancock and Mueller's artificial unidimensional dataset consisting of four 
#' items. 
#' 
#' @docType data
#' @usage data(HancockMueller)
#' @source Hancock, G., & Mueller, R. O. (2001). Rethinking construct 
